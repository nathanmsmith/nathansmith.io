...
export enum FileFieldsEnum {
  ...
  ChildMarkdownRemarkFrontmatterToc = 'childMarkdownRemark___frontmatter___toc',
...
export enum MarkdownRemarkFieldsEnum {
  ...
  FrontmatterToc = 'frontmatter___toc',
...
export type MarkdownRemarkFrontmatterFilterInput = {
  ...
  toc?: Maybe<BooleanQueryOperatorInput>;
...
export type HeadQuery = (
  ...
  & { site: Maybe<(
    ...
    & { siteMetadata: Maybe<(
      { __typename?: 'SiteSiteMetadata' }
      & Pick<SiteSiteMetadata, 'siteUrl' | 'siteTitle' | 'description' | 'twitter'>
    )> }
  )> }
);
...
export type PortraitPickerQuery = (
  { __typename?: 'Query' }
  & { allFile: (
    { __typename?: 'FileConnection' }
    & { edges: Array<(
...
export type PostQuery = (
  ...
  & { markdownRemark: Maybe<(
    { __typename?: 'MarkdownRemark' }
    & Pick<MarkdownRemark, 'htmlAst' | 'timeToRead' | 'tableOfContents'>
    & { frontmatter: Maybe<(
      { __typename?: 'MarkdownRemarkFrontmatter' }
      & Pick<MarkdownRemarkFrontmatter, 'toc' | 'title' | 'link' | 'subtitle' | 'date' | 'updatedDate' | 'draft'>
    )> }
  )> }
);
  ...
  & { markdownRemark: Maybe<(
    ...
    & { edges: Array<(
      ...
      & { node: (
        ...
        & { frontmatter: Maybe<(
          { __typename?: 'MarkdownRemarkFrontmatter' }
          & Pick<MarkdownRemarkFrontmatter, 'title' | 'organization' | 'dates' | 'link' | 'githubLink' | 'role' | 'technologies'>
          & { image: Maybe<(
            { __typename?: 'File' }
            & { childImageSharp: Maybe<(
              { __typename?: 'ImageSharp' }
    ...
    & { edges: Array<(
      ...
      & { node: (
        ...
        & { frontmatter: Maybe<(
          ...
          & { year: MarkdownRemarkFrontmatter['date'], ISODate: MarkdownRemarkFrontmatter['date'], date: MarkdownRemarkFrontmatter['date'] }
        )>, fields: Maybe<(
          { __typename?: 'MarkdownRemarkFields' }
